...
<body>
	...
	// p.270~
	// http 프로토콜을 사용하여 통신시
	// 페이지 요청(request), 요청에 대한 응답(response)를 완룔하고 나면
	// 서버와 클라이언트의 연결은 종료.
	// => 서버와 클라이언트의 상태를 연결하기 위해서 세션, 쿠키 사용

	%>
	
	<h2>세션(Session) : 웹 서버의 컨테이너 정보(상태)를 유지하기 위한 정보
	- 웹 브라우저당 1개씩 설정 <br>
	- 서버쪽에서 관리 => 보안상 안전
	</h2>
